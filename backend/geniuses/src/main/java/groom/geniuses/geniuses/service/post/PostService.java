package groom.geniuses.geniuses.service.post;

import groom.geniuses.geniuses.dao.post.Post;
import groom.geniuses.geniuses.util.PaginationUtil;
...
import groom.geniuses.geniuses.dao.post.PostRepository;
import groom.geniuses.geniuses.dao.post.UserRepository;
import groom.geniuses.geniuses.util.PaginationUtil;
...
public class PostService {
    ...
    public PostBoardDTO getPostBoard(int page, int pageSize) {
        ...
        postBoardDTO.totalPage = PaginationUtil.getTotalPage(postBoardDTO.total, postBoardDTO.pageSize);
    ...
    public Post createPost(PostDTO postDTO) {
        Post post = new Post();
        Member user = userRepository.findById(postDTO.getUserId()).orElseThrow(() -> new RuntimeException("User not found"));
